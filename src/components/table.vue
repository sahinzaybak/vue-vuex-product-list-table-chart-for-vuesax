  ...
  <div class="table">
    <div class="table-wrp">
      ...
      <div class="table-container">
        <!--tablo begin  -->
        <b-table
          id="my-table" hover :filter="filter"  :filterIncludedFields="filterOn" @filtered="onFiltered" :items="tableRow" :per-page="perPage" :current-page="currentPage" small></b-table>
        <!--tablo end  -->
...
export default {
  ...
  methods: {
    onFiltered(filteredItems) { //tabloda arama 
